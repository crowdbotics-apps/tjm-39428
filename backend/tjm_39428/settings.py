"""
Django settings for tjm_39428 project.
...
WSGI_APPLICATION = 'tjm_39428.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tjm_39428 API",
    "DESCRIPTION": "API documentation for tjm_39428 App",
    "VERSION": "v1",
}
